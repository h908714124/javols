...
class MapperTest {
  ...
  void mapperValidExtendsFunction() {
    ...
    assertAbout(javaSources()).that(singletonList(javaFile))
        .processedWith(new Processor())
        .failsToCompile()
        .withErrorContaining("expected java.util.function.Function but found test.MyData.StringFunction<E,java.lang.Integer>");
  }
  ...
  void mapperInvalidStringFunction() {
    ...
    assertAbout(javaSources()).that(singletonList(javaFile))
        .processedWith(new Processor())
        .failsToCompile()
        .withErrorContaining("expected java.util.function.Function but found test.MyData.StringFunction<java.lang.Integer>");
  }
  ...
  void testMapperTypeSudokuLooksValidButIsnt() {
    ...
    assertAbout(javaSources()).that(singletonList(javaFile))
        .processedWith(new Processor())
        .failsToCompile()
        .withErrorContaining("expected java.util.function.Function but found test.MyData.Foo<E>");
  }
  ...
  void mapperInvalidComplicatedTree() {
    ...
    assertAbout(javaSources()).that(singletonList(javaFile))
        .processedWith(new Processor())
        .failsToCompile()
        .withErrorContaining("expected java.util.function.Function but found test.MyData.Zapper");
  }
