...
import static net.javol.compiler.Constants.NONPRIVATE_ACCESS_MODIFIERS;
...
public final class Parameter {
  ...
  static Parameter create(boolean anyMnemonics, TypeTool tool, List<Parameter> alreadyCreated, ExecutableElement sourceMethod, Integer positionalIndex, String[] description, ClassName optionType) {
    ...
    if (positionalIndex != null) {
      Optional<TypeElement> mapperClass = annotationUtil.get(net.javol.Param.class, "mappedBy");
  ...
  private static Parameter createPositional(
      ...
      ClassName optionType,
      TypeTool tool) {
    net.javol.Param parameter = sourceMethod.getAnnotation(net.javol.Param.class);
