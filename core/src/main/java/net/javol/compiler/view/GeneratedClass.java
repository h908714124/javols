...
import net.javol.compiler.Constants;
...
import static net.javol.compiler.Constants.ENTRY_STRING_STRING;
import static net.javol.compiler.Constants.STRING;
import static net.javol.compiler.Constants.STRING_ARRAY;
import static net.javol.compiler.Constants.STRING_ITERATOR;
import static net.javol.compiler.Constants.STRING_TO_STRING_MAP;
