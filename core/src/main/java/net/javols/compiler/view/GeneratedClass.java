...
import net.javols.compiler.Constants;
...
import static net.javols.compiler.Constants.ENTRY_STRING_STRING;
import static net.javols.compiler.Constants.STRING;
import static net.javols.compiler.Constants.STRING_ARRAY;
import static net.javols.compiler.Constants.STRING_ITERATOR;
import static net.javols.compiler.Constants.STRING_TO_STRING_MAP;
...
public final class GeneratedClass {
  ...
  private static final String PROJECT_URL = "https://github.com/h908714124/javol";
  ...
  private CodeBlock javadoc() {
    return CodeBlock.builder().add("Generated by <a href=\"" + PROJECT_URL + "\">javol " +
